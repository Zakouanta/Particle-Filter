 ...
 * Set to 100 as first try
 */
#define NPARTICLES 700
...
double sigma_pos[3] = {0.02, 0.02, 0.01};
double sigma_landmark[2] = {0.18, 0.18}; //[x,y] sensor measurement noise. Try values between [0.5 and 0.1]
